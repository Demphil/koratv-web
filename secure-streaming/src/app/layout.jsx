...
export const metadata = {
  ...
  title: {
    default: "koratv - Watch Live Football Matches Today",
    template: `%s | ${SITE_NAME}`
  },
  description: "koratv Football brings today's live football matches, secure match pages, Arabic sports coverage, and multi-quality streaming options in one fast experience.",
  keywords: [
    "koratv",
    "كورة لايف",
    "live football",
